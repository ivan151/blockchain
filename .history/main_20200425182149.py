...
from functions import node_dirs, write_block, write_block_to_nodes, change_block, get_hash, int_and_sort, create_key, check_integrity
from functions import blockchain_dir, nodes_route, restore_integrity
import random
import uuid
import json
import os
...
def transaction():
    public_keys = [user.public_key for user in User.query.all()]
    if request.method == 'POST':
        ...
        return render_template('transactions.html', keys = public_keys)
