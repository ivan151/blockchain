...
def transaction():
    ...
    if request.method == 'POST':
        ...
        return render_template('transactions.html', sender=sender_public_key, receiver=receiver_public_key, amount=amount, sender_private_key = sender.private_key users=users)
    else:
